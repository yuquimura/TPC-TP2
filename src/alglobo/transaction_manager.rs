...
mod tests {
    ...
    use crate::{
        ...
        sockets::{
            ...
            udp_socket_receiver::MockUdpSocketReceiver
        },
    ...
    //     let accept_msg_clone = accept_msg.clone();
    ...
    //         .withf(move |_| true)
    //         .returning(|_| 
    //             Ok((accept_msg_clone, airline_addr.to_string())
    //         ));
    ...
    //         .withf(move |_| true)
    //         .returning(|_| 
    //             Ok((accept_msg_clone, hotel_addr.to_string())
    //         ));
    ...
    //         .withf(move |_| true)
    //         .returning(|_| 
    //             Ok((accept_msg_clone, bank_addr.to_string())
    //         ));   
