...
pub struct TransactionReceiver {
    ...
    curr_transaction: Arc<(Mutex<Option<Box<dyn Transactionable>>>, Condvar)>
}
...
impl TransactionReceiver {
    ...
    pub fn recv(&mut self) -> Result<(), TransactionError>{
        ...
        match transaction_code {
            ...
            _ => panic!("Codigo de transaccion no esperado: {}", transaction_code)
        }
